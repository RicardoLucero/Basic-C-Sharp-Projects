    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("The Second number is optional." +
                "\n if no number is wanted please press enter.");// we now ask for the second input, we let them know its optional
            ...
            {
                int total = myObj.MyMethod(x, Convert.ToInt32(y));// we call the method and pass the arguments over
                Console.WriteLine(total);
            }
        }
    }
